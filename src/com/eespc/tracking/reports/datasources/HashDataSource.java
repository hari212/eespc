...
// Source File Name:   HashDataSource.java
...
public class HashDataSource extends AbstractDataSource {

	public HashDataSource(List _dataList) {
		super(_dataList);
	}
	...
	static {
		log = LogFactory
				.getLog(com.eespc.tracking.reports.datasources.HashDataSource.class);
	}
}
