...
public class PressListAction extends Action {

	public PressListAction() {
	}
	...
	public ActionForward execute(ActionMapping actionmapping,
		...
		if (dynaactionform.get("formId") == null
			...
			log.debug("BridgeListAction - In Execute");
	...
	private void getHydraulicTankListInfo(HttpServletRequest httpservletrequest)
		...
		java.util.List list = PrintingPressEntity
				.getFacilityStackList(facilityvo.getId());
		System.out.println((new StringBuilder()).append("List=").append(list)
				.toString());
		if (list != null)
			httpsession.setAttribute("PRESS_SEARCH_LIST", list);
		else
			httpsession.setAttribute("PRESS_SEARCH_LIST", new ArrayList());
	}

	private static Log log = LogFactory
			.getLog(com.eespc.tracking.actions.PressListAction.class);
