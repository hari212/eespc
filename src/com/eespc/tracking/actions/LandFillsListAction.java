...
public class LandFillsListAction extends Action {

	public LandFillsListAction() {
	}
	...
	public ActionForward execute(ActionMapping actionmapping,
		...
		if (dynaactionform.get("formId") == null
			...
			log.debug("BulkOxygenListAction - In Execute");
	...
	private void getHydraulicTankListInfo(HttpServletRequest httpservletrequest)
		...
		java.util.List list = LandfillEntity.getFacilityStackList(facilityvo
				.getId());
		System.out.println((new StringBuilder()).append("List=").append(list)
				.toString());
		if (list != null)
			httpsession.setAttribute("LANDFILLS_SEARCH_LIST", list);
		else
			httpsession.setAttribute("LANDFILLS_SEARCH_LIST", new ArrayList());
	}

	private static Log log = LogFactory
			.getLog(com.eespc.tracking.actions.LandFillsListAction.class);
