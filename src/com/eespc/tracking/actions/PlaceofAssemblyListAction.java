...
public class PlaceofAssemblyListAction extends Action {

	public PlaceofAssemblyListAction() {
	}
	...
	public ActionForward execute(ActionMapping actionmapping,
		...
		if (dynaactionform.get("formId") == null
			...
			log.debug("PlaceofAssemblyListAction - In Execute");
	...
	private void getHydraulicTankListInfo(HttpServletRequest httpservletrequest)
		...
		java.util.List list = PlaceofAssemblyEntity
				.getFacilityStackList(facilityvo.getId());

		System.out.println((new StringBuilder()).append("List=").append(list)
				.toString());
		if (list != null)
			httpsession.setAttribute("PLACEOFASSEMBLY_SEARCH_LIST", list);
		else
			httpsession.setAttribute("PLACEOFASSEMBLY_SEARCH_LIST",
					new ArrayList());
	}

	private static Log log = LogFactory
			.getLog(com.eespc.tracking.actions.PlaceofAssemblyListAction.class);
