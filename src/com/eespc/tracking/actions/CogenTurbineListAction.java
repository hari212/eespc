...
public class CogenTurbineListAction extends Action {

	private static Log log = LogFactory
			.getLog(com.eespc.tracking.actions.CogenTurbineListAction.class);

	public CogenTurbineListAction() {
	}
	...
	private void getCoGenListInfo(HttpServletRequest httpservletrequest)
		...
		java.util.List list = CogenTurbineEntity
