...
public class BulkOxygenListAction extends Action {

	private static Log log = LogFactory
			.getLog(com.eespc.tracking.actions.BulkOxygenListAction.class);

	public BulkOxygenListAction() {
	}
	...
	private void getHydraulicTankListInfo(HttpServletRequest httpservletrequest)
		...
		System.out.println((new StringBuilder()).append("List=").append(list)
				.toString());
		if (list != null) {
			httpsession.setAttribute("BULK_SEARCH_LIST", list);
		} else {
			httpsession.setAttribute("BULK_SEARCH_LIST", new ArrayList());
		}
	}
