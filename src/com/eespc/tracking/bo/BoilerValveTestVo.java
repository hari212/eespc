...
public class BoilerValveTestVo implements Serializable {
	...
	public BoilerValveTestVo(ResultSet resultset) throws SQLException {
		id = -99;
		boilerId = -99;
		year = null;
		date = null;
		...
		// isRecordsKept = false;
		dateForDisplay = null;
		id = UtilityObject.getIntFromString(resultset.getString("VALVETESTID"));
		...
		// isRecordsKept =
		// UtilityObject.convertBoolean(resultset.getString("ISRECORDSKEPT"));
	}
	...
	/*
	 * public boolean isRecordsKept() { return isRecordsKept; }
	 * 
	 * public void setRecordsKept(boolean flag) { isRecordsKept = flag; }
	 */
	...
	public String toString() {
		...
		stringbuffer.append("performedBy =").append(performedBy);
