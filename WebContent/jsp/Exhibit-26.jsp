...
<a href="jsp/Exhibit-26xls.jsp" target="_blank"><img border="0" src="images/xls.gif" width="16" height="16"></a>&nbsp;&nbsp;
...
conn = utilObj.getConnection(); 
    ...
    <br>
<body>
<p align="center"><font color="#01688A"><b>REPORT 26: SUMMARY OF 12-MONTH 
ROLLING CONSUMPTION HISTORY FOR GENERATOR&nbsp; FOR '<%=str.toUpperCase()%>'</b></font><hr>
<%
					List printlist=fromseventh.getNycdobStatusReport26(facilityvo.getId());
                    int psize =0;
					...
					if (printlist != null)
					{
						...
						//out.println("Generator ID: "+(String)hashtable.get("FACILITYDESIGNATEDID")+"<br>");
