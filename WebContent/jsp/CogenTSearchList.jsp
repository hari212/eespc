...
<BODY>
	<html:form action="/CogenTListInfo">			
<BR><BR>
		<eespc:table dataSource="COGEN_LIST"
		  formName="form1"
		  noDataFoundMessage="<CENTER><SPAN CLASS=error>No Cogen system available in this facility.</SPAN></CENTER>" >
		  ...
		  <eespc:tableBodyCellDef id="b_Type" method="getResourceName"/>		  
		  ...
		  <eespc:tableBodyCellDef id="b_Serial" method="getSerialNumber"/>		  
