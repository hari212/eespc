...
function setInfo(){
	...
	if (radioChecked(formObj) == "false"){
		...
		opener.document.forms[0].<bean:write name="stackListInfo" property="formId" />.value=id;
		opener.document.forms[0].<bean:write name="stackListInfo"  property="formIdName"  />.value=idName;
		self.close();		
	}
}
</script>
...
<BODY>
	<html:form action="/StackListInfo">			
<BR><BR>
