...
<table border="0" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="707" >
    ...
    <tr>
    <td width="881" height="33">
   
    <img border="0" src="images/pdf.gif" width="18" height="16">&nbsp;
    <a href="jsp/Excel17.jsp">
    <img border="0" src="images/xls.gif" width="19" height="16"></a>
    <img border="0" src="images/first_grey.gif" width="23" height="23"><img border="0" src="images/previous_grey.gif" width="23" height="23"><img border="0" src="images/next_grey.gif" width="23" height="23"><img border="0" src="images/last_grey.gif" width="23" height="23"></td>
  </tr>
    <tr>
    <td width="881" height="33">
...
conn = utilObj.getConnection();
  ...
  <tr>
    <td width="881" height="64">
    <p align="center"><b><font color="#01688A">EXHIBIT 17:MASTER REPORT FOR '<%=str.toUpperCase()%>'</font></b></td>
  </tr>
  </table>
</td>
  </tr>
...
conn = utilObj.getConnection();
 ...
 st=conn.prepareStatement("SELECT d.buildingname,a.address1,d.dobbinnumber,d.blocknumber,d.lotnumber,d.bldgsixstories FROM building d,facility f,address a WHERE a.addressid=d.addressid AND d.FACILITYID = f.FACILITYID AND f.FACILITYID=?");
            st.setString(1,String.valueOf(TestFacility.getCurrentFacilityID()));
             rs=st.executeQuery();
            while(rs.next())
            {
  ...
  <tr>
    ...
    <td width="21%" height="19"><font size="1"><%=checkNullAndFill(rs.getString("buildingname"),"N/A")%></font></td>
    <td width="22%" height="19"><font size="1"><%=checkNullAndFill(rs.getString("address1"),"N/A")%></font></td>
    <td width="10%" height="19"><font size="1"><%=checkNullAndFill(rs.getString("dobbinnumber"),"N/A")%></font></td>
    <td width="10%" height="19"><font size="1"><%=checkNullAndFill(rs.getString("blocknumber"),"N/A")%></font></td>
    <td width="9%" height="19"><font size="1"><%=checkNullAndFill(rs.getString("lotnumber"),"N/A")%></font></td>
    
        <%
    String s1=rs.getString("bldgsixstories");
...
conn = utilObj.getConnection();
 ...
 st=conn.prepareStatement("select blr.actiontaken,blr.manufacturer,blr.dep,bpf.expirationdate from  building bld, generator blr left join generatorpermitinfo bpf on blr.generatorid=bpf.generatorid where (blr.STATUS='1' or blr.STATUS='5')and blr.buildingid=bld.buildingid and bld.facilityid=? order by blr.generatorid asc, blr.buildingid asc, bpf.gnrtpermitid  asc");
    ...
    <td width="30%" height="19" align="center"><font size="1"><%=checkNullAndFill(rs.getString("manufacturer"),"N/A")%></font></td>
    <td width="17%" height="19" align="center"><font size="1"><%=checkNullAndFill(rs.getString("dep"),"N/A")%></font></td>
    <td width="19%" height="19" align="center"><font size="1"><%=checkNullAndFilldate(rs.getString("expirationdate"),"N/A")%></font></td>
   <td width="21%" height="19" align="center"><font size="1"><%=checkNullAndFill(rs.getString("actiontaken"),"N/A")%></font></td>
  </tr>
...
conn = utilObj.getConnection();
 ...
 st=conn.prepareStatement("select e.actiontaken,f.facilitytype,e.MODEL,e.MANUFACTURER,e.MODEL,e.dep,e.dob,b.BUILDINGNAME,et.TESTDATE,ep.EXPIRATIONDATE from (eto e,building b,facility f) left join etopermitinfo ep on ep.ETOID = e.ETOID and depid='4' left join etotestinfo et on et.ETOID = e.ETOID where (e.MODIFIEDINPAST='1' or e.MODIFIEDINPAST='5') and e.BUILDINGID = b.BUILDINGID AND b.FACILITYID=f.facilityid and f.facilityid=?");
			st.setString(1,String.valueOf(TestFacility.getCurrentFacilityID()));
             rs=st.executeQuery();
            while(rs.next())
            {
            String typ=rs.getString("facilitytype");
            String yes="";
            if(typ.equals("1"))
            {
            	yes="Y";
  ...
  <tr>
    ...
    <td width="9%"><font size="1"><%=checkNullAndFill(rs.getString("MANUFACTURER"),"N/A")%></font>&nbsp;</td>
    <td width="9%"><font size="1"><%=checkNullAndFill(rs.getString("MODEL"),"N/A")%></font>&nbsp;</td>
    <td width="9%"><font size="1"><%=checkNullAndFill(rs.getString("MANUFACTURER"),"N/A")%></font>&nbsp;</td>
    <td width="9%"><font size="1"><%=checkNullAndFill(rs.getString("MODEL"),"N/A")%></font>&nbsp;</td>
    <td width="9%"><font size="1"><%=checkNullAndFill(rs.getString("dep"),"N/A")%></font>&nbsp;</td>
    <td width="9%"><font size="1"><%=checkNullAndFilldate(rs.getString("EXPIRATIONDATE"),"N/A")%></font>&nbsp;</td>
    <td width="9%"><font size="1"><%=checkNullAndFill(rs.getString("dob"),"N/A")%></font>&nbsp;</td>
    <td width="9%"><font size="1"><%=checkNullAndFill(yes,"N/A")%></font>&nbsp;</td>
    <td width="9%"><font size="1"><%=checkNullAndFilldate(rs.getString("TESTDATE"),"N/A")%></font>&nbsp;</td>
     <td width="9%"><font size="1"><%=checkNullAndFill(rs.getString("ACTIONTAKEN"),"N/A")%></font>&nbsp;</td>  </tr>
  <%         
i=i+1;   	
            }
...
conn = utilObj.getConnection();
 ...
 st=conn.prepareStatement("select blr.comments,blr.stacktestdate,blr.manufacturer,blr.serial,blr.dep,bpf.expirationdate,blr.protocolsubmitdate from  building bld, boiler blr left join boilerpermitinfo bpf on blr.boilerid=bpf.boilerid and bpf.depid='1' where (blr.MODIFIEDINPAST='1' or blr.MODIFIEDINPAST='5') and blr.buildingid=bld.buildingid and bld.facilityid=? order by blr.boilerid asc, blr.buildingid asc, bpf.boilerpermitid asc");
  ...
  <tr>
    ...
    <td width="20%" height="31"><font size="1"><%=checkNullAndFill(rs.getString("manufacturer"),"N/A")%></font></td>  
    <td width="12%" height="31"><font size="1"><%=checkNullAndFill(rs.getString("serial"),"N/A")%></font></td>    
    <td width="14%" height="31"><font size="1"><%=checkNullAndFill(rs.getString("dep"),"N/A")%></font></td>
    <td width="14%" height="31"><font size="1"><%=checkNullAndFilldate(rs.getString("expirationdate"),"N/A")%></font></td>
    <td width="15%" height="31"><font size="1"><%=checkNullAndFill(rs.getString("comments"),"N/A")%></font></td> 
    <td width="15%" height="31"><font size="1"><%=checkNullAndFilldate(rs.getString("stacktestdate"),"N/A")%></font></td>
 </tr>
...
<table border="0" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber10">
  ...
  <tr>
    <td width="100%" colspan="4" bgcolor="#01688A"><b>
    <font size="2" color="#FFFFFF">CHILLERS</font></b></td>
  </tr>
  <tr>
    <td width="10%" align="center" bgcolor="#01688A"><b>
    <font size="1" color="#FFFFFF">No</font></b></td>
    <td width="32%" align="center" bgcolor="#01688A"><b>
    <font size="1" color="#FFFFFF">Make</font></b></td>
    <td width="29%" align="center" bgcolor="#01688A"><b>
...
conn = utilObj.getConnection();
 ...
 st=conn.prepareStatement("SELECT a.make,a.serial,a.dobapproval FROM building d,facility f,chillerabsorber a WHERE (a.MODIFIEDINPAST='1' or a.MODIFIEDINPAST='5') and a.buildingid=d.buildingid AND d.FACILITYID = f.FACILITYID AND f.FACILITYID=?");
            st.setString(1,String.valueOf(TestFacility.getCurrentFacilityID()));
             rs=st.executeQuery();
            while(rs.next())
            {
  ...
  <tr>
    <td width="10%"><font size="1"><%=i%></font>&nbsp;</td>
    <td width="32%"><font size="1"><%=checkNullAndFill(rs.getString("make"),"N/A")%></font>&nbsp;</td>
    <td width="29%"><font size="1"><%=checkNullAndFill(rs.getString("serial"),"N/A")%></font>&nbsp;</td>
    <td width="29%"><font size="1"><%=checkNullAndFill(rs.getString("dobapproval"),"N/A")%></font>&nbsp;</td>
  </tr>
  <%         
i=i+1;   	
            }
...
conn = utilObj.getConnection();
 ...
 st=conn.prepareStatement("select a.serialnumber,a.dobpermitnumber,a.deppermitnumber,c.lastinspectiondate,c.nextinspectiondate,b.expirationdate from building x,rpz a left join rpzinspectioninfo c  on c.rpzid=a.rpzid left join rpzpermitinfo b on b.rpzid=a.rpzid where a.buildingid=x.buildingid and x.facilityid=?");
  ...
  <tr>
    <td width="10%"><font size="1"><%=i%></font>&nbsp;</td>
    <td width="15%"><font size="1"><%=checkNullAndFill(rs.getString("serialnumber"),"N/A")%></font>&nbsp;</td>
    <td width="17%"><font size="1"><%=checkNullAndFill(rs.getString("dobpermitnumber"),"N/A")%></font>&nbsp;</td>
    <td width="16%"><font size="1"><%=checkNullAndFill(rs.getString("deppermitnumber"),"N/A")%></font>&nbsp;</td>
    <td width="25%"><font size="1"><%=checkNullAndFilldate(rs.getString("lastinspectiondate"),"N/A")%></font>&nbsp;</td>
    <td width="17%"><font size="1"><%=checkNullAndFilldate(rs.getString("nextinspectiondate"),"N/A")%></font>&nbsp;</td>
    <td width="17%"><font size="1"><%=checkNullAndFilldate(rs.getString("expirationdate"),"N/A")%></font>&nbsp;</td>
...
conn = utilObj.getConnection();
 ...
 st=conn.prepareStatement("select g.facilitydesignatedid,s.tankstatus,g.capacity,c.tanktype,d.testdate,d.nexttestdate from (building a,storagetank g) left join tanktype c on c.id=g.tanktype left join tanktightnessinfo d on g.STORAGETANKID=d.storagetankid left join tankstatus s on g.tankstatus=s.statusid where (g.TANKSTATUS='1' or g.TANKSTATUS='5') and g.buildingid=a.buildingid and a.facilityid=?");
            ...
            while(rs.next())
            {
            	...
            	%>
  <tr>
    <td width="14%" align="center"><font size="1"><%=checkNullAndFill(rs.getString("facilitydesignatedid"),"N/A")%></font>&nbsp;</td>
    <td width="20%" align="center"><font size="1"><%=checkNullAndFill(rs.getString("capacity"),"N/A")%></font>&nbsp;</td>
    <td width="19%" align="center"><font size="1"><%=checkNullAndFill(rs.getString("tanktype"),"N/A")%></font>&nbsp;</td>
    <td width="14%" align="center"><font size="1"><%=checkNullAndFilldate(rs.getString("testdate"),"N/A")%></font>&nbsp;</td>
    <td width="15%" align="center"><font size="1"><%=checkNullAndFilldate(rs.getString("nexttestdate"),"N/A")%></font>&nbsp;</td>
    <td width="18%" align="center"><font size="1"><%=checkNullAndFill(rs.getString("tankstatus"),"N/A")%></font>&nbsp;</td>
  </tr>
...
conn = utilObj.getConnection();
 ...
 st=conn.prepareStatement("select b.permitnumber,b.FileNo,c.actiontaken,d.type,a.buildingname,b.issuedate,b.expirationdate,b.lastinspdate,b.nextinspdate from (building a,bridgetunnels c,bridgetype d) left join bridgetunnelpermitinfo b on c.bridgetunnelid=b.bridgetunnelid and b.depid='9' where (c.MODIFIEDINPAST='1' or c.MODIFIEDINPAST='5') and c.isbridge=d.che and c.buildingid=a.buildingid and a.facilityid=?");
			st.setString(1,String.valueOf(TestFacility.getCurrentFacilityID()));
             rs=st.executeQuery();
            while(rs.next())
            {
  ...
  <tr>
    <td width="10%" align="center"><font size="1"><%=checkNullAndFill(rs.getString("type"),"N/A")%></font>&nbsp;</td>
    <td width="16%" align="center"><font size="1"><%=checkNullAndFill(rs.getString("buildingname"),"N/A")%></font>&nbsp;</td>
    <td width="8%" align="center"><font size="1"><%=checkNullAndFill(rs.getString("permitnumber"),"N/A")%></font>&nbsp;</td>
    <td width="9%" align="center"><font size="1"><%=checkNullAndFill(rs.getString("FileNo"),"N/A")%></font>&nbsp;</td>
    <td width="12%" align="center"><font size="1"><%=checkNullAndFilldate(rs.getString("issuedate"),"N/A")%></font>&nbsp;</td>
    <td width="11%" align="center"><font size="1"><%=checkNullAndFilldate(rs.getString("expirationdate"),"N/A")%></font>&nbsp;</td>
    <td width="11%" align="center"><font size="1"><%=checkNullAndFilldate(rs.getString("lastinspdate"),"N/A")%></font>&nbsp;</td>
    <td width="10%" align="center"><font size="1"><%=checkNullAndFilldate(rs.getString("nextinspdate"),"N/A")%></font>&nbsp;</td>
    <td width="13%" align="center"><font size="1"><%=checkNullAndFill(rs.getString("actiontaken"),"N/A")%></font>&nbsp;</td>
  </tr>
