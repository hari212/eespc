...
function setInfo(){
	...
	if (radioChecked(formObj) == "false"){
		...
		opener.document.forms[0].<bean:write name="tankListInfo" property="formId" />.value=id;
		opener.document.forms[0].<bean:write name="tankListInfo"  property="formIdName"  />.value=idName;
		self.close();		
	}
}
</script>
...
<BODY>
	<html:form action="/FuelTankListInfo">			
<BR><BR>
