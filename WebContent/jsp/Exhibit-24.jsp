...
<a href="jsp/Exhibit-24xls.jsp" target="_blank"><img border="0" src="images/xls.gif" width="16" height="16"></a>&nbsp;&nbsp;
...
conn = utilObj.getConnection(); 
    ...
    <br>
<body>
<p align="center"><font color="#01688A"><b>REPORT 24: SUMMARY OF 12-MONTH 
ROLLING CONSUMPTION HISTORY FOR GENERATOR&nbsp; FOR '<%=str.toUpperCase()%>'</b></font><hr>
<%
					List printlist=fromseventh.getNycdobStatusReport24(facilityvo.getId());
                    int psize =0;
