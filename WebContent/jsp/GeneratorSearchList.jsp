...
<BODY>
	<html:form action="/GeneratorListInfo">			
<BR><BR>
		<eespc:table dataSource="GENERATOR_SEARCH_LIST"
		  formName="form1"
		  noDataFoundMessage="<CENTER><SPAN CLASS=error>No Generator  available in this facility.</SPAN></CENTER>" >
