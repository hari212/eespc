...
<BODY>
	<html:form action="/BridgeListInfo">			
<BR><BR>
		<eespc:table dataSource="BRIDGE_SEARCH_LIST"
		  formName="form1"
		  noDataFoundMessage="<CENTER><SPAN CLASS=error>No Bridge-Tunnel available in this facility.</SPAN></CENTER>" >
		  
		  <eespc:tableHeaderCellDef id="h_Bridge" label="ISBRIDGE" bodyCellId="b_Bridge"/>		
		  ...
		  <eespc:tableBodyCellDef id="b_Bridge" method="getBridge"/>		  
