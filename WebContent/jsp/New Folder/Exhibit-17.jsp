...
PreparedStatement st1=conn.prepareStatement("SELECT a.make,a.serial,a.dobapproval FROM building d,facility f,chillerabsorber a WHERE (a.MODIFIEDINPAST='1' or a.MODIFIEDINPAST='5') and a.buildingid=d.buildingid AND d.FACILITYID = f.FACILITYID AND f.FACILITYID=?");
            st1.setString(1,String.valueOf(TestFacility.getCurrentFacilityID()));
            ResultSet rs1=st1.executeQuery();
            while(rs1.next())
            {
  ...
  <tr>
    <td width="10%"><font size="1"><%=i%></font>&nbsp;</td>
    <td width="32%"><font size="1"><%=checkNullAndFill(rs1.getString("make"),"N/A")%></font>&nbsp;</td>
    <td width="29%"><font size="1"><%=checkNullAndFill(rs1.getString("serial"),"N/A")%></font>&nbsp;</td>
    <td width="29%"><font size="1"><%=checkNullAndFill(rs1.getString("dobapproval"),"N/A")%></font>&nbsp;</td>
  </tr>
  <%         
i=i+1;   	
            }
