...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
  ...
  <tr>
    ...
    <td width="215" bgcolor="#006699" align="center"><b>
    <font face="Verdana" color="#FFFFFF" size="2">Hydraulic Storage&nbsp; Tanks</font></b></td>
 ...
 <%
  ...
  %>
  <tr>
    <td width="1930" colspan="21" align="center"><b>
    <font face="Verdana" size="2">No Results</font></b></td>
  </tr>
  <%
  }
  %>
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber3" height="30">
  <tr>
    <td width="100%" colspan="18" height="18">
  ...
  <tr>
    ...
    <td width="9%" height="44" bgcolor="#006699" rowspan="2" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">&nbsp;Compliance&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    Comments&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font></b></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="5%" height="3" bgcolor="#FFFFFF" align="center">&nbsp;<%=hashtable.get("comments")%></td>
  </tr>
  <%
  	}
  		}
  ...
  %>
  <tr>
    <td width="100%" height="3" bgcolor="#FFFFFF" colspan="18">
    <p align="center"><b><font face="Verdana" size="2">No Results</font></b></td>
  </tr>
  <%
  }
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber4">
  <tr>
    <td width="100%" colspan="11" align="center"><b>
  ...
  <tr>
    ...
    <td width="9%" rowspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Block</font></b></td>
    <td width="9%" rowspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">LOT</font></b></td>
    <td width="9%" rowspan="2" align="center" bgcolor="#006699"><b>
  ...
  <tr>
    ...
    <td width="9%" align="center">&nbsp;<%=hashtable.get("aka")%></td>
    <td width="9%" align="center">&nbsp;<%=hashtable.get("block")%></td>
    <td width="9%" align="center">&nbsp;<%=hashtable.get("lot")%></td>
    ...
    <td width="9%" align="center">&nbsp;<%=hashtable.get("reportDueDate")%></td>
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="101%" id="AutoNumber5">
  ...
  <tr>
    ...
    <td width="9%" align="center" bgcolor="#006699"><b>
    <font color="#FFFFFF" size="2" face="Verdana">Boiler</font></b></td>
    ...
    <td width="10%" align="center" bgcolor="#006699"><b>
    <font color="#FFFFFF" size="2" face="Verdana">Tune-Up Report Submitted</font></b></td>
    <td width="11%" align="center" bgcolor="#006699"><b>
    <font color="#FFFFFF" size="2" face="Verdana">DEC Stack Test 
    Required</font></b></td>
    <td width="9%" align="center" bgcolor="#006699"><b>
    <font color="#FFFFFF" size="2" face="Verdana">Next Stack 
    Test Date</font></b></td>
    <td width="10%" align="center" bgcolor="#006699"><b>
  ...
  <tr>
    ...
    <td width="12%">&nbsp;<%=hashtable.get("tuneUpPerformed")%></td>
    <td width="10%">&nbsp;<%=hashtable.get("when")%></td>
    <td width="10%">&nbsp;<%=hashtable.get("whom")%></td>
  ...
  %>
  <tr>
    <td width="100%" colspan="10" align="center"><b>
    <font face="Verdana" size="2">No Results</font></b></td>
  </tr>
    <%
  }
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="115%" id="AutoNumber6">
  ...
  <tr>
    ...
    <td width="6%" rowspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Location</font></b></td>
    <td width="3%" rowspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Year Installed&nbsp; </font>
    </b></td>
    <td width="20%" colspan="4" bgcolor="#006699">
    <p align="center"><b><font size="2" face="Verdana" color="#FFFFFF">Maximum 
    Capacity</font></b></td>
    ...
    <font size="2" face="Verdana" color="#FFFFFF"><%=dob%> PERMIT No</font></b></td>
    <td width="12%" colspan="2" bgcolor="#006699">
    <p align="center"><b><font size="2" face="Verdana" color="#FFFFFF"><%=dep%></font></b></td>
    <td width="54%" colspan="4" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">COMPLIANCE WITH THE STATE</font></b></td>
    <td width="6%" rowspan="2" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Compliance&nbsp;<br>Status
    </font></b></td>
  </tr>
  <tr>
    <td width="7%" bgcolor="#006699">
    <p align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">MM BTU/HR</font></b></td>
    <td width="4%" align="center" bgcolor="#006699"><b>
    ...
    <font size="2" face="Verdana" color="#FFFFFF">Expiration Date</font></b></td>
    <td width="5%" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">PLM Participation</font></b></td>
    <td width="5%" bgcolor="#006699" align="center"><b>
  ...
  %>
  <tr>
    <td width="6%" align="center">&nbsp;<%=hashtable.get("generatorid")%></td>
    <td width="6%" align="center">&nbsp;<%=hashtable.get("manufacturer")%></td>
    <td width="6%" align="center">&nbsp;<%=hashtable.get("model")%></td>
    <td width="6%" align="center">&nbsp;<%=hashtable.get("serial")%></td>
    <td width="6%" align="center">
    <p align="left">&nbsp;<%=hashtable.get("buildingname")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("yearinstalled")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("mmbtu")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("hp")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("kw")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("gph")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("fuel")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("dob")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("dep")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("expirationdate")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("stackpermit")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("stacktest")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("lasttest")%></td>
    <td width="11%" align="center">&nbsp;<%=hashtable.get("nexttest")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("compliancestatus2")%></td>
  </tr>
  <%
  	}
  		}
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="116%" id="AutoNumber7">
  ...
  <tr>
    ...
    <td width="16%" colspan="2" bgcolor="#006699">
    <p align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Tightness Test Date</font></b></td>
    <td width="10%" rowspan="2" bgcolor="#006699">
    <p align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Testing Company</font></b></td>
    <td width="10%" rowspan="2" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Operating Status</font></b></td>
    <td width="7%" rowspan="2" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Location</font></b></td>
    ...
    <td width="5%" rowspan="2" bgcolor="#006699">
    <p align="center"><b><font size="2" face="Verdana" color="#FFFFFF">
    Compliance Status</font></b></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="7%" align="center">&nbsp;<%=hashtable.get("tankstored")%></td>
    <td width="8%" align="center">&nbsp;<%=hashtable.get("tanktype")%></td>
    <td width="8%" align="center">&nbsp;<%=hashtable.get("TESTDATE")%></td>
    <td width="8%" align="center">&nbsp;<%=hashtable.get("NEXTTESTDATE")%></td>
    <td width="10%" align="center">&nbsp;<%=hashtable.get("testcompany")%></td>
    <td width="10%" align="center">&nbsp;<%=hashtable.get("tankstatus")%></td>
    <td width="7%" align="center">
    <p align="left">&nbsp;<%=hashtable.get("BUILDINGNAME")%></td>
    <td width="8%" align="center">&nbsp;<%=hashtable.get("boilerid")%></td>
    <td width="8%" align="center">&nbsp;<%=hashtable.get("EXPIRATIONDATE")%></td>
    <td width="5%" align="center">&nbsp;<%=hashtable.get("compliancestatus")%></td>
  </tr>
  <%
  	}
  		}
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="119%" id="AutoNumber8">
  ...
  <tr>
    <td width="3%" rowspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Id</font></b></td>
    <td width="15%" colspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Sterilizer</font></b></td>
    <td width="12%" colspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Abator </font></b> </td>
    <td width="7%" rowspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Location&nbsp;&nbsp;&nbsp;&nbsp;
    </font></b> </td>
    <td width="12%" colspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Avg. Use</font></b></td>
    <td width="17%" colspan="3" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF"><%=dep%></font></b>&nbsp;</td>
    <td width="8%" rowspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF"><%=dob%> Permit</font></b></td>
    <td width="5%" rowspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Last<br>Test Date</font></b></td>
    <td width="6%" rowspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Next<br>Test Date</font></b></td>
    <td width="9%" rowspan="2" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Compliance Status</font></b></td>
  </tr>
  <tr>
    ...
    <td width="6%" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Days/Yr</font></b></td>
    <td width="7%" align="center" bgcolor="#006699"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Permit. No</font></b></td>
    <td width="6%" align="center" bgcolor="#006699"><b>
  ...
  <tr>
    <td width="3%">&nbsp;<%=hashtable.get("eid")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("MANUFACTURER")%></td>
    <td width="6%">&nbsp;<%=hashtable.get("MODEL")%></td>
    <td width="6%">&nbsp;<%=hashtable.get("amake")%></td>
    <td width="6%">&nbsp;<%=hashtable.get("amodel")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("BUILDINGNAME")%></td>
    <td width="6%">&nbsp;<%=hashtable.get("days")%></td>
    <td width="6%">&nbsp;<%=hashtable.get("hrs")%></td>
    <td width="6%">&nbsp;<%=hashtable.get("dep")%></td>
    <td width="6%">&nbsp;<%=hashtable.get("ISSUEDATE")%></td>
    <td width="5%">&nbsp;<%=hashtable.get("EXPIRATIONDATE")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("dob")%></td>
 
    <td width="5%">&nbsp;<%=hashtable.get("TESTDATE")%></td>
    <td width="6%">&nbsp;<%=hashtable.get("NEXTTESTDATE")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("compliancestatus")%></td>
  </tr>
    <%
  	}
  		}
  ...
  %>
  <tr>
    <td width="100%" align="center" colspan="15"><b>
    <font face="Verdana" size="2">No Results</font></b></td>
  </tr>
  <%
  }
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber9">
  <tr>
    ...
    <font size="2">REPORT 9: LIST OF CHILLERS, AGENCY APPROVALS AND INSPECTION REPORTS FOR '<%=str.toUpperCase()%>'</font></span></td>
  </tr>
  <tr>
    <td width="5%" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Id</font></b></td>
    <td width="13%" bgcolor="#006699" align="center"><b>
    ...
    <font size="2" face="Verdana" color="#FFFFFF">Serial No</font></b></td>
    <td width="9%" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF"><%=dob%> Approval</font></b></td>
    <td width="9%" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF"><%=dep%> Approval</font></b></td>
    <td width="9%" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Permit Exp. Date</font></b></td>
  ...
  %>
  <tr>
    <td width="5%">&nbsp;<%=hashtable.get("facilitydesinatedid")%></td>
    <td width="13%">&nbsp;<%=hashtable.get("capacity")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("buildingname")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("floor")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("make")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("model")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("serial")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("dobapproval")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("depapproval")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("expirationdate")%></td>
    <td width="10%">&nbsp;<%=hashtable.get("compliancestatus")%></td>
  </tr>
  <%
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber10">
  ...
  <tr>
    ...
    <td width="11%" rowspan="2" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Inspected</font></b></td>
  ...
  <tr>
    <td width="11%">&nbsp;<%=hashtable.get("BUILDINGNAME")%></td>
    <td width="11%">&nbsp;<%=hashtable.get("ADDRESS1")%></td>
    <td width="11%">&nbsp;<%=hashtable.get("ELEVATORID")%></td>
    <td width="11%">&nbsp;<%=hashtable.get("PERMITNUMBER")%></td>
    <td width="11%">&nbsp;<%=hashtable.get("LASTINSPECTIONDATE")%></td>
    <td width="11%">&nbsp;<%=hashtable.get("SUBMITTALDATE")%></td>
    <td width="11%">&nbsp;<%=hashtable.get("NEXTINSPECTIONDATE")%></td>
    <td width="11%">&nbsp;<%=hashtable.get("FIRMINSPECTED")%></td>
    <td width="12%">&nbsp;<%=hashtable.get("COMPLIANCESTATUS")%></td>
  </tr>
  <%
  	}
  		}
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber11">
  ...
  <tr>
    <td width="5%" align="center" bgcolor="#006699">
    <b>
    <font color="#FFFFFF" size="2" face="Verdana">No</font></b></td>
    <td width="6%" align="center" bgcolor="#006699">
    <b>
    ...
    <td width="9%" align="center" bgcolor="#006699"><b>
    <font size="2" color="#FFFFFF" face="Verdana"><%=dep%></font></b>&nbsp;</td>
    <td width="10%" align="center" bgcolor="#006699"><b>
    <font size="2" color="#FFFFFF" face="Verdana">Expiration Date</font></b></td>
    <td width="8%" align="center" bgcolor="#006699"><b>
  ...
  <tr>
    ...
    <td width="6%">&nbsp;<%=hashtable.get("SERIALNUMBER")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MODEL")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("SIZE")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("TYPE")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("DOBPERMITNUMBER")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("DEPPERMITNUMBER")%></td>
    <td width="10%">&nbsp;<%=hashtable.get("EXPIRATIONDATE")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("LASTINSPECTIONDATE")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("NEXTINSPECTIONDATE")%></td>
  ...
  %>
  <tr>
    <td width="102%" colspan="13" align="center"><b>
    <font face="Verdana" size="2">No Results</font></b></td>
  </tr>
   <%
  }
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="121%" id="AutoNumber12" height="118">
  ...
  <tr>
    ...
    <font size="2" face="Verdana" color="#FFFFFF">Location</font></b></td>
    <td width="4%" rowspan="3" bgcolor="#006699" align="center" height="82"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Year</font></b></td>
    <td width="12%" rowspan="2" colspan="3" bgcolor="#006699" align="center" height="49">
  ...
  %>
  <tr>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("cid")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("enginemanufacturer")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("turbinemanufacturer")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("whrbmanufacturer")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("enginemodel")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("turbinemodel")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("whrbmodel")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("engineserial")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("turbineserial")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("whrbserial")%></td>
    <td width="6%" height="19">&nbsp;<%=hashtable.get("location")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("year")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("enginecapacity")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("turbinecapacity")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("whrbcapacity")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("engineprimary")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("turbineprimary")%></td>
    <td width="3%" height="19">&nbsp;<%=hashtable.get("whrbprimary")%></td>
    <td width="3%" height="19">&nbsp;<%=hashtable.get("enginesecondary")%></td>
    <td width="4%" height="19">&nbsp;<%=hashtable.get("turbinesecondary")%></td>
    <td width="3%" height="19">&nbsp;<%=hashtable.get("whrbsecondary")%></td>
    <td width="3%" height="19">&nbsp;<%=hashtable.get("enginegph")%></td>
    <td width="3%" height="19">&nbsp;<%=hashtable.get("enginecfh")%></td>
    <td width="3%" height="19">&nbsp;<%=hashtable.get("turbinegph")%></td>
    <td width="3%" height="19">&nbsp;<%=hashtable.get("turbinecfh")%></td>
    <td width="3%" height="19">&nbsp;<%=hashtable.get("whrbgph")%></td>
    <td width="3%" height="19">&nbsp;<%=hashtable.get("whrbcfh")%></td>
  </tr>
  ...
  %>
  <tr>
    <td width="101%" height="19" colspan="27">
    <p align="center"><b><font face="Verdana" size="2">No Results</font></b></td>
  </tr>
  <%
  }
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber13">
  ...
  <tr>
    ...
    <font color="#FFFFFF" size="2" face="Verdana">ID</font></b></td>
    <td width="15%" align="center" rowspan="2" bgcolor="#006699"><b>
    <font color="#FFFFFF" size="2" face="Verdana">Location</font></b></td>
    <td width="10%" align="center" rowspan="2" bgcolor="#006699"><b>
    <font color="#FFFFFF" size="2" face="Verdana"><%=dob%> Permit No.</font></b></td>
    <td width="16%" colspan="2" align="center" bgcolor="#006699"><b>
    <font color="#FFFFFF" size="2" face="Verdana"><%=dep%></font></b>&nbsp;</td>
    <td width="33%" colspan="3" align="center" bgcolor="#006699"><b>
    <font color="#FFFFFF" size="2" face="Verdana">Compliance With The State</font></b></td>
    <td width="22%" align="center" rowspan="2" bgcolor="#006699"><b>
  ...
  %>
  <tr>
    <td width="4%">&nbsp;<%=hashtable.get("facilitydesinatedid")%></td>
    <td width="15%">&nbsp;<%=hashtable.get("location")%></td>
    <td width="10%">&nbsp;<%=hashtable.get("dobpermit")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("deppermit")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("expirationdate")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("stacktest")%></td>
    <td width="9%">&nbsp;<%=hashtable.get("lasttestdate")%></td>
    <td width="15%">&nbsp;<%=hashtable.get("nexttestdate")%></td>
    <td width="22%">&nbsp;<%=hashtable.get("compliancestatus")%></td>
  </tr>
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber15">
  ...
  <tr>
    ...
    <td width="16%" colspan="2" bgcolor="#006699" align="center"><b>
    <font color="#FFFFFF" size="2" face="Verdana">Hours of Operation</font></b></td>
    <td width="8%" rowspan="2" bgcolor="#006699" align="center"><b>
    <font color="#FFFFFF" size="2" face="Verdana">VOC Emissions tons/Yr</font></b></td>
    <td width="8%" rowspan="2" bgcolor="#006699" align="center"><b>
  ...
  <tr>
    <td width="8%" bgcolor="#006699" align="center"><b>
    <font color="#FFFFFF" size="2" face="Verdana">Hrs/Day</font></b></td>
    <td width="8%" bgcolor="#006699" align="center"><b>
    <font color="#FFFFFF" size="2" face="Verdana">Days/Annual</font></b></td>
    <td width="8%" bgcolor="#006699" align="center"><b>
    <font color="#FFFFFF" size="2" face="Verdana">No</font></b></td>
    <td width="8%" bgcolor="#006699" align="center"><b>
    <font color="#FFFFFF" size="2" face="Verdana">Expiration Date</font></b></td>
  ...
  <tr>
    <td width="7%">&nbsp;<%=hashtable.get("FACILITYDESIGNATEDID")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("LOCATION")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MAKE")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MODEL")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("HROFOPERATION")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("WEEKYEARS")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("VOC")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("CHEMICAL")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("INCLUDEDINDECPERMIT")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("DEP")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("EXPIRATIONDATE")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("DOB")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("compliance")%></td>
  </tr>
  <%
  	}
  		}
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="112%" id="AutoNumber17">
  ...
  %>
  <tr>
    <td width="100%" colspan="15" align="center"><b>
    <font face="Verdana" size="2">No Results</font></b></td>
  </tr>
    <%
  }
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber18">
  ...
  <tr>
    ...
    <font size="2" face="Verdana" color="#FFFFFF">Capacity</font></b></td>
    <td width="13%" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Supplied to Elevator#</font></b></td>
    <td width="15%" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Secondary Containment </font>
    </b></td>
    <td width="11%" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">DEC/PBS Approval</font></b></td>
    <td width="11%" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Monthly Inspection</font></b></td>
    <td width="11%" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Spill Kit</font></b></td>
    <td width="12%" bgcolor="#006699" align="center"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Compliance Status</font></b></td>
  </tr>
   <%
  ...
  <tr>
    <td width="7%">&nbsp;<%=hashtable.get("FACILITYDESIGNATEDID")%></td>
    <td width="10%">&nbsp;<%=hashtable.get("BUILDINGNAME")%></td>
    <td width="10%">&nbsp;<%=hashtable.get("CAPACITY")%></td>
    <td width="13%">&nbsp;<%=hashtable.get("LISTOFELEVATOR")%></td>
    <td width="15%">&nbsp;<%=hashtable.get("ISSECONDARYCONTAINMENT")%></td>
    <td width="11%">&nbsp;<%=hashtable.get("DECAPPROVAL")%></td>
    <td width="11%">&nbsp;<%=hashtable.get("MONTHLYINSPECTION")%></td>
    <td width="11%">&nbsp;<%=hashtable.get("SPILLKIT")%></td>
    <td width="12%">&nbsp;<%=hashtable.get("compliance")%></td>
  </tr>
   <%
  	}
  		}
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber19" height="70">
  <tr>
    <td width="100%" colspan="7" height="18">
    <p align="center">
    <span style="font-family: Verdana; color: rgb(1, 104, 138); font-weight: 700; background-color: rgb(255, 255, 255)">
  ...
  <tr>
    ...
    <font size="2" color="#FFFFFF" face="Verdana">Id</font></b></td>
    <td width="14%" rowspan="2" bgcolor="#006699" align="center" height="33"><b>
    <font size="2" color="#FFFFFF" face="Verdana">Location</font></b></td>
    <td width="13%" rowspan="2" bgcolor="#006699" align="center" height="33"><b>
    ...
    <td width="24%" colspan="2" bgcolor="#006699" align="center" height="16"><b>
    <font size="2" color="#FFFFFF" face="Verdana">5Yr.Pressure Test</font></b></td>
    <td width="27%" rowspan="2" bgcolor="#006699" align="center" height="33"><b>
    <font size="2" color="#FFFFFF" face="Verdana">Compliance Status</font></b></td>
  </tr>
  <tr>
    <td width="12%" bgcolor="#006699" align="center" height="16"><b>
  ...
  <tr>
    <td width="9%" height="17"><%=hashtable.get("FACILITYDESIGNATEDID")%></td>
    <td width="14%" height="17"><%=hashtable.get("BUILDINGNAME")%></td>
    <td width="13%" height="17"><%=hashtable.get("FIREDEPTAPPROVAL")%></td>
    <td width="13%" height="17"><%=hashtable.get("FIREDEPTAPPROVALNO")%></td>
    <td width="12%" height="17"><%=hashtable.get("LASTTESTDATE")%></td>
    <td width="12%" height="17"><%=hashtable.get("NEXTTESTDATE")%></td>
    <td width="27%" height="17"><%=hashtable.get("COMPLIANCESTATUS")%></td>
  </tr>
    <%
  	}
  		}
  ...
  %>
  <tr>
    <td width="100%" height="17" colspan="7">
    <p align="center"><b><font face="Verdana" size="2">No Results</font></b></td>
  </tr>
   <%
  }
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber20">
  ...
  <tr>
    ...
    <td width="7%" bgcolor="#006699" align="center"><b>
    <font color="#FFFFFF" size="2" face="Verdana">DEC Permit (Y/N)</font></b></td>
    <td width="7%" bgcolor="#006699" align="center"><b>
    <font color="#FFFFFF" size="2" face="Verdana"><%=dob%> Permit#</font></b></td>
    <td width="6%" bgcolor="#006699" align="center"><b>
    <font color="#FFFFFF" size="2" face="Verdana"><%=dep%> Permit#</font></b></td>
    <td width="8%" bgcolor="#006699" align="center"><b>
    <font color="#FFFFFF" size="2" face="Verdana"><%=dep%> Expiration Date</font></b></td>
    <td width="7%" bgcolor="#006699" align="center"><b>
    <font color="#FFFFFF" size="2" face="Verdana">Compliance Status</font></b></td>
  </tr>
  <%    
  ...
  <tr>
    ...
    <td width="7%" rowspan="6" valign="top" align="center"><%=hashtable.get("SOLVANTCAP")%>&nbsp;</td>
    <td width="7%" rowspan="6" valign="top" align="center"><%=hashtable.get("DECPERMIT")%>&nbsp;</td>
    <td width="7%" rowspan="6" valign="top" align="center"><%=hashtable.get("DOBPERMIT")%>&nbsp;</td>
    <td width="6%" rowspan="6" valign="top" align="center"><%=hashtable.get("DEPNUMBER")%>&nbsp;</td>
    <td width="8%" rowspan="6" valign="top" align="center"><%=hashtable.get("DEPEXPIRATIONDATE")%>&nbsp;</td>
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber21">
  ...
  <tr>
    ...
    <font color="#FFFFFF" size="2" face="Verdana">Flue Gas Quality</font></b></td>
    <td width="7%" rowspan="2" bgcolor="#006699" align="center"><b>
  ...
  <tr>
    <td width="7%">&nbsp;<%=hashtable.get("FACILITYDESIGNATEDID")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("BUILDINGNAME")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("COMMENCEDDATE")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("LFGQUANTITY")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("LFGCOMBUSTION")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("SVALUE")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("CH4VALUE")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("TEMPERATUREVALUE")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("NOXVALUE")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("COVALUE")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("OVALUE")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("YEARLYVALUE")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("AESDATE")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("COMPLIANCESTATUS")%></td>
  </tr>
  <%
  	}
  		}
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber22">
  ...
  <tr>
    <td width="7%">&nbsp;<%=hashtable.get("FACILITYDESIGNATEDID")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("BUILDINGNAME")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MISNAME")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MISMAKE")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MISMODEL")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MISCAPACITY")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MISDEP")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MISDOB")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MISDOH")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MISDEC")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MISFD")%></td>
    <td width="7%">&nbsp;<%=hashtable.get("MISEXPIRATIONDATE")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("MISTESTSUBMITTED")%></td>
    <td width="8%">&nbsp;<%=hashtable.get("COMPLIANCESTATUS")%></td>
  </tr>
   <%
  	}
...
<table border="1" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber23">
  ...
  <tr>
    ...
    <font size="2" face="Verdana" color="#FFFFFF">S.No</font></b></td>
    <td width="7%" rowspan="2" align="center" bgcolor="#01688A"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Id</font></b></td>
    <td width="7%" rowspan="2" align="center" bgcolor="#01688A"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Location</font></b></td>
    ...
    <font size="2" face="Verdana" color="#FFFFFF"><%=dob%> Permit#</font></b></td>
    <td width="7%" rowspan="2" align="center" bgcolor="#01688A"><b>
    <font size="2" face="Verdana" color="#FFFFFF"><%=dob%> Issue Date</font></b></td>
    <td width="21%" colspan="3" align="center" bgcolor="#01688A"><b>
    <font size="2" face="Verdana" color="#FFFFFF">EPA Refrigeration Recovery 
    Registration Status</font></b></td>
    <td width="7%" rowspan="2" align="center" bgcolor="#01688A"><b>
    <font size="2" face="Verdana" color="#FFFFFF">FD Approval Availability</font></b></td>
  ...
  <tr>
    ...
    <font size="2" face="Verdana" color="#FFFFFF">Registered or Not</font></b></td>
    <td width="7%" align="center" bgcolor="#01688A"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Submittal Date</font></b></td>
    <td width="7%" align="center" bgcolor="#01688A"><b>
    <font size="2" face="Verdana" color="#FFFFFF">Records As per EPA Maintained</font></b></td>
  </tr>
  <%
  ...
  <tr>
    ...
    <td width="7%" align="center">&nbsp;<%=hashtable.get("CAPACITYTONS")%></td>
    <td width="7%" align="center">&nbsp;<%=hashtable.get("DOBPERMIT")%></td>
    <td width="7%" align="center">&nbsp;<%=hashtable.get("DOBISSUEDATE")%></td>
    <td width="7%" align="center">&nbsp;<%=hashtable.get("EPASTATUS")%></td>
    <td width="7%" align="center">&nbsp;<%=hashtable.get("EPASUBMITTALDATE")%></td>
    <td width="7%" align="center">&nbsp;<%=hashtable.get("EPAMAINTAINED")%></td>
    <td width="7%" align="center">&nbsp;<%=hashtable.get("FDAPPROVAL")%></td>
    <td width="8%" align="center">&nbsp;<%=hashtable.get("FDAPPROVALDATE")%></td>
...
<table border="1" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber24" height="92">
  ...
  <tr>
    <td width="100%" colspan="12" height="16">
    <p align="center"><b><font face="Verdana" size="2">No Results</font></b></td>
  </tr>
    <%
  }
