...
<BODY>
	<html:form action="/BoilerSearchInfo">			
<BR><BR>
		<eespc:table dataSource="BOILER_SEARCH_LIST"
		  formName="form1"
		  noDataFoundMessage="<CENTER><SPAN CLASS=error>No boiler available in this facility.</SPAN></CENTER>" >
