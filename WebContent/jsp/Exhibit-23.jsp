...
<a href="jsp/Exhibit-23xls.jsp" target="_blank"><img border="0" src="images/xls.gif" width="16" height="16"></a>&nbsp;&nbsp;
...
int gcurrent[]=new int[12];
 ...
 out.println(""+df.format(monthlynox));
   ...
   float stt=rt/1000000;
   float tmonthlyso2=(qt+stt)/2000; 
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2" height="142">
  <tr>
    ...
    <b><font face="Verdana" size="2" color="#CCFFFF">Gas Rolling Limit (CFY)</font></b></td>
    <td width="17%" bgcolor="#669999" align="center" height="19"><b>
    <font face="Verdana" size="2" color="#CCFFFF">Oil Rolling Limit (GPY)</font></b></td>
  </tr>
  <tr>
    ...
    <b><font face="Verdana" size="2" color="#CCFFFF"><%=FGASFUELGAPPING%></font></b></td>
    <td width="17%" bgcolor="#669999" height="21" align="center">
    <b><font face="Verdana" size="2" color="#CCFFFF"><%=FOILFUELGAPPING%></font></b></td>
  </tr>
  <tr>
