...
function setInfo(){
	...
	if (radioChecked(formObj) == "false"){
		alert("Please select a Fume Hood.");
	}else{
		var id ="";
		var idName="" ;
...
<BODY>
	<html:form action="/FumehoodListInfo">			
<BR><BR>
		<eespc:table dataSource="FUMEHOOD_SEARCH_LIST"
		  formName="form1"
		  noDataFoundMessage="<CENTER><SPAN CLASS=error>No Fume Hood available in this facility.</SPAN></CENTER>" >
