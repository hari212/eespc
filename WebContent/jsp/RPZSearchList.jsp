...
<BODY>
	<html:form action="/RPZListInfo">			
<BR><BR>
		<eespc:table dataSource="RPZ_SEARCH_LIST"
		  formName="form1"
		  noDataFoundMessage="<CENTER><SPAN CLASS=error>No RPZ available in this facility.</SPAN></CENTER>" >
