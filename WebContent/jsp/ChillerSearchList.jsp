...
<BODY>
	<html:form action="/ChillerSearchInfo">			
<BR><BR>
		<eespc:table dataSource="CHILLER_SEARCH_LIST"
		  formName="form1"
		  noDataFoundMessage="<CENTER><SPAN CLASS=error>No Chiller-Absorber available in this facility.</SPAN></CENTER>" >
