...
conn = utilObj.getConnection();
			...
			st=conn.prepareStatement("select a.clientname,a.facilitytype,b.address1,b.city,b.state,b.zipcode from (facility a,address b) where a.addressid=b.addressid and a.facilityid=?");
