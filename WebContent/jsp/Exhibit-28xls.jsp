...
conn = utilObj.getConnection();
    ...
    <br>
<body>
<p align="center"><font color="#01688A"><b>REPORT 28:OTHER REGULATORY 
COMPLIANCE EVALUATIONS TASKS<span style="text-transform: uppercase"> </span>FOR '<%=str.toUpperCase()%>'</b></font><hr>
<%
