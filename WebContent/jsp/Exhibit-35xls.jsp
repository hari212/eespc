...
<table border="0" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" cellpadding="7" height="166">
  ...
  <tr>
    <td width="100%" height="31" colspan="10">
    ...
    try
{
  ...
  <tr>
   ...
   <tr>
    <td width="100%" height="2" colspan="11">
     <hr color="#000000"></td>
  </tr>
...
<table border="1" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
  ...
  <tr>
    ...
    <td width="7%" align="center" valign="top"><font face="Verdana" size="2"><%=(String)hashtable.get("VIOLATIONNO")%>&nbsp;</font></td>
    <td width="9%" align="center" valign="top"><font face="Verdana" size="2"><%=(String)hashtable.get("VIOLATIONWHICH")%>&nbsp;</font></td>
    <td width="9%" align="center" valign="top"><font face="Verdana" size="2"><%=(String)hashtable.get("VIOLATIONTYPE")%>&nbsp;</font></td>
    <td width="9%" align="center" valign="top"><font face="Verdana" size="2"><%=(String)hashtable.get("BUILDINGNAME")%>&nbsp;</font></td>
...
<tr><td width="602" height="16">
 ...
 <td width="640" colspan="9">
  <p align="center">&nbsp;<p align="right"><SPAN 
