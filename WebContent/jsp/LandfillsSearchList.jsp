...
function setInfo(){
	...
	if (radioChecked(formObj) == "false"){
		alert("Please select a Land Fill.");
	}else{
		var id ="";
		var idName="" ;
...
<BODY>
	<html:form action="/LandfillsListInfo">			
<BR><BR>
		<eespc:table dataSource="LANDFILLS_SEARCH_LIST"
		  formName="form1"
		  noDataFoundMessage="<CENTER><SPAN CLASS=error>No Land Fill available in this facility.</SPAN></CENTER>" >
