...
function validateThis(){
        ...
        alert("This is new");
           var c = document.forms[0].lfTurbines.options.length;
           alert( "Total options " + document.forms[0].lfTurbines.options.length);
           for (var i= 0;i<c;i++)
              alert( "Name " + document.forms[0].lfTurbines.options[i].value);
