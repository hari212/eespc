...
function addOther(updateFlag)
{
	...
	else if(isdateFieldEnteredcheckdate(document.forms[0].misissuedate)==false)
	{
       	
        	document.forms[0].misissuedate.focus();
        	return false;
    		  
        	
	}

	else if(isdateFieldEnteredcheckdate(document.forms[0].misexpirationdate) ==false)
	{
       
        	document.forms[0].misexpirationdate.focus();
        	return false;
