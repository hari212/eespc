function validateDep(){
	if (document.forms[0].psDEPNumber.value.length ==0 || document.forms[0].psDEPIssueDate.value.length ==0 || document.forms[0].psDEPExpirationDate.value.length ==0)
	{
		...
		return false;		
	        ...
	        if (!isNumeric(document.forms[0].psDEPNumber.value, "DEP Number "))
	        {   
	            return false;
	        }
	      
	        if (!isDate(document.forms[0].psDEPIssueDate.value))
	        {   
	            alert("Invalid DEP issue Date");
	            return false;
	        }
	        
	        if (!isDate(document.forms[0].psDEPExpirationDate.value))
	        {   
	            alert("Invalid DEP Expiration Date");
	            return false;
	        }

	dateFrom = chkdate(document.forms[0].psDEPIssueDate);
	dateTo   = chkdate(document.forms[0].psDEPExpirationDate);
...
function validateLoc(){
	if (document.forms[0].psLocIssueDate.value.length ==0 || document.forms[0].psLocExpirationDate.value.length ==0 )
        {
		alert("Please enter all the mandatory building information.");
		return false;		
	}
	        if (!isDate(document.forms[0].psLocIssueDate.value))
	        {   
	            alert("Invalid Location Issue Date");
	            return false;
	        }
	        
	        if (!isDate(document.forms[0].psLocExpirationDate.value))
	        {   
	            alert("Invalid Location Expiration Date");
	            return false;
	        }

	dateFrom = chkdate(document.forms[0].psLocIssueDate);
	dateTo   = chkdate(document.forms[0].psLocExpirationDate);
...
function validateState(){
	if (document.forms[0].psStateIssueDate.value.length ==0 ||document.forms[0].psStateExpirationDate.value.length ==0 )
		...
		return false;		
	        ...
	        if (!isDate(document.forms[0].psStateIssueDate.value))
	        {   
	            alert("Invalid State issue Date");
	            return false;
	        }
	        
	        if (!isDate(document.forms[0].psStateExpirationDate.value))
	        {   
	            alert("Invalid State Expiration Date");
	            return false;
	        }

	dateFrom = chkdate(document.forms[0].psStateIssueDate);
	dateTo   = chkdate(document.forms[0].psStateExpirationDate);
...
function validate(){
	...
	{
	     var year = document.forms[0].psHoursOfOperation.value;
             return isNumeric(year, "Hourse of Operation ");
	}
...
function searchStack(){
	var url = "/eespc/StackListInfo.do?formId=psStackIDForm&formIdName=psStackID";
